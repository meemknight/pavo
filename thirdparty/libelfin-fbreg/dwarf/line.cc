...
#pragma GCC diagnostic warning "-Wswitch-enum"
				...
				case DW_LNE::lo_user:
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)1) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)2) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)3) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)4) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)5) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)6) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)7) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)8) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)9) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)10) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)11) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)12) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)13) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)14) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)15) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)16) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)17) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)18) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)19) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)21) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)22) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)23) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)24) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)25) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)26) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)27) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)28) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)29) :
				case (DW_LNE)((ubyte)DW_LNE::lo_user + (ubyte)30) :
				case DW_LNE::hi_user:
